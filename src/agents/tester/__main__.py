...
from agents.tester import AutomatedTester
...
async def main():
    ...
    try:
        ...
        # Create and start tester agent
        tester = AutomatedTester(
            knowledge_base=knowledge_base,
            message_bus=message_bus,
        )
        
        logger.info("Starting Automated Tester Agent...")
        await tester.start()
        ...
        logger.error(f"Error running tester agent: {e}")
        sys.exit(1)
