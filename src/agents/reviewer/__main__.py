#!/usr/bin/env python3
"""Main entry point for reviewer agent."""
...
async def main():
    ...
    try:
        ...
        # Create and start reviewer agent
        reviewer = CodeReviewer(
            knowledge_base=knowledge_base,
            message_bus=message_bus,
        )
        
        logger.info("Starting Code Reviewer Agent...")
        ...
        logger.error(f"Error running reviewer agent: {e}")
        sys.exit(1)
