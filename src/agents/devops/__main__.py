...
from agents.devops import DeploymentAgent
...
async def main():
    ...
    try:
        ...
        # Create and start devops agent
        devops = DeploymentAgent(
            knowledge_base=knowledge_base,
            message_bus=message_bus,
        )
        
        logger.info("Starting DevOps Deployment Agent...")
        await devops.start()
        ...
        logger.error(f"Error running devops agent: {e}")
        sys.exit(1)
